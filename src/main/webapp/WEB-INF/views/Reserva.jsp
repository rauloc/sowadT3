...
<link href="<c:url value="/resources/diseño/css/reserva.css"/>" rel="stylesheet" type="text/css"/>
<script src="<c:url value="/resources/diseño/js/jquery.min.js"/>"></script>
<script src="<c:url value="/resources/diseño/js/jquery.form.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/diseño/js/plugins/jquery.smartWizard-2.0.min.js"/>" type="text/javascript"></script>
</head>
<body>
<div id="popup3" >
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" class="stdtable stdtablecb" id="table2">
                                            ...
                                            <tbody>                                
                                                ...
                                                <tr id="tr<%= aux.getIdFuncion()%>">
                                                    ...
                                                    <td class="center">
                                                        <img id="loadingFunciones" src="<c:url value="/resources/diseño/images/loader3.gif"/>"/><input style="display:none" type="radio" class="mostarFuncion"  name="idfuncion" id="<%=aux.getSala().getIdSala()%>" value="<%= aux.getIdFuncion()%>">
